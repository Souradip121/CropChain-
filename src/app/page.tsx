          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="mt-4 text-lg text-cropchain-medium max-w-2xl mx-auto">
                CropChain opens new funding channels for farmers while providing
                investors with unique exposure to agricultural yields.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="flex flex-col items-center text-center p-6 rounded-xl bg-cropchain-gray/30 dark:bg-cropchain-dark/60">
                <div className="w-16 h-16 rounded-full bg-cropchain-green-light flex items-center justify-center mb-4">
                  <span className="text-2xl font-semibold text-cropchain-green">
                    1
                  </span>
                </div>
                <h3 className="text-xl font-medium mb-2">For Farmers</h3>
                <p className="text-cropchain-medium mb-4">
                  Access new capital without debt. Tokenize your future harvest
                  and sell shares directly to investors.
                </p>
                <Link href="/farmer-dashboard" className="mt-auto">
                  <Button
                    variant="outline"
              ...
              <div className="flex flex-col items-center text-center p-6 rounded-xl bg-cropchain-gray/30 dark:bg-cropchain-dark/60">
                <div className="w-16 h-16 rounded-full bg-cropchain-blue-light flex items-center justify-center mb-4">
                  <span className="text-2xl font-semibold text-cropchain-blue">
                    2
                  </span>
                </div>
                <h3 className="text-xl font-medium mb-2">For Investors</h3>
                <p className="text-cropchain-medium mb-4">
                  Diversify your portfolio with agricultural assets. Purchase
                  tokens representing future crop yields.
                </p>
                <Link href="/investor-dashboard" className="mt-auto">
                  <Button
                    variant="outline"
                    className="border-cropchain-gray/50 hover:bg-cropchain-gray/20"
                  >
              ...
              <div className="flex flex-col items-center text-center p-6 rounded-xl bg-cropchain-gray/30 dark:bg-cropchain-dark/60">
                ...
                <p className="text-cropchain-medium mb-4">
                  Browse available tokens, analyze yields, and trade
                  agricultural assets with ease.
                </p>
              ...
              <div className="flex flex-col items-center text-center p-6 rounded-xl bg-cropchain-gray/30 dark:bg-cropchain-dark/60">
                ...
                <p className="text-cropchain-medium mb-4">
                  Access educational resources on farming techniques,
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center relative z-10">
                <div className="lg:col-span-3">
                  ...
                  <p className="mt-4 text-lg text-cropchain-medium">
                    Join our platform today to tokenize your crop yields or
                    invest in agricultural futures.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="md:col-span-1">
                ...
                <p className="mt-4 text-sm text-cropchain-medium">
                  Revolutionizing agricultural investment with tokenized crop
                  yields.
                </p>
              </div>

              <div>
                <h3 className="text-sm font-semibold mb-4 text-cropchain-dark dark:text-white">
                  Product
                </h3>
