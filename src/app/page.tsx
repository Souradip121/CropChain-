            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <Link href="/marketplace" className="text-cropchain-medium hover:text-cropchain-dark dark:hover:text-white transition-colors">Marketplace</Link>
                  </li>
                  <li>
                    <Link href="/farmer-dashboard" className="text-cropchain-medium hover:text-cropchain-dark dark:hover:text-white transition-colors">Farmer Tools</Link>
                  </li>
                  <li>
                    <Link href="/investor-dashboard" className="text-cropchain-medium hover:text-cropchain-dark dark:hover:text-white transition-colors">Investor Dashboard</Link>
                  </li>
                </ul>
              </div>
